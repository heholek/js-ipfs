...
module.exports = (common, options) => {
  ...
  describe('.object.patch.addLink', function () {
    ...
    it('should respect timeout option when adding a link to an object', () => {
      return testTimeout(() => ipfs.object.patch.addLink(new CID('Qmd7qZS4T7xXtsNFdRoK1trfMs5zU94EpokQ9WFtxdPxsZ'), { cid: new CID('Qmd7qZS4T7xXtsNFdRoK1trfMs5zU94EpokQ9WFtxdPxsZ') }, {
        timeout: 1
      }))
    })
